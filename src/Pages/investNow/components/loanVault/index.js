    ...
    <div className="loanVault-main-wrapper">
      <div className="loanTerm-wrapper">
        <LoanTerm
          ...
          dollar={_indStakingInf && (_indStakingInf[0].dollarGiven/1000000000000000000).toFixed(2)}
        />
        <LoanTerm
          ...
          dollar={_indStakingInf && (_indStakingInf[1].dollarGiven/1000000000000000000).toFixed(2)}
        />
      </div>
      <div className="loanInvestment-wrapper">
        <LoanInvestment
          ...
          interestPaidPercentageValue="0.2"
          busdLoanAvailablePercentageValue="50"
          tft={_indStakingInf && (_indStakingInf[0].quantity/100000000).toFixed(2)}
          daily={_indStakingInf && (_indStakingInf[0].daily/100000000).toFixed(2)}
          dollar={_indStakingInf && (_indStakingInf[0].dollarGiven/1000000000000000000).toFixed(2)}
          withdraw={Unstake30}
          index={_indStakingInf && _indStakingInf[0].stakingId}
          allowance={_indStakingInf && Number(_BUSDAllowance) >= Number(_indStakingInf[0].dollarGiven)}
          disable={_indStakingInf && _indStakingInf[0].dollarGiven==0}
        />
        <LoanInvestment
          headingText="45 Days Term"
          interestPaidPercentageValue="0.2"
          busdLoanAvailablePercentageValue="50"
          tft={_indStakingInf && (_indStakingInf[1].quantity/100000000).toFixed(2)}
          daily={_indStakingInf && (_indStakingInf[1].daily/100000000).toFixed(2)}
          dollar={_indStakingInf && (_indStakingInf[1].dollarGiven/1000000000000000000).toFixed(2)}
          withdraw={Unstake45}
          index={_indStakingInf && _indStakingInf[1].stakingId}
          allowance={_indStakingInf && Number(_BUSDAllowance) >= Number(_indStakingInf[1].dollarGiven)}
          disable={_indStakingInf && _indStakingInf[1].dollarGiven==0}
        />
      </div>
    </div>
